  ...
  template: `<ul>
        <li>
            <a href="index.html" class="" :aria-current="isActive('index')" aria-label="Home">
                ...
                <svg fill="none" xmlns="http://www.w3.org/2000/svg" class="logo" viewBox="0 0 199 48" aria-hidden="true">
                    <path
        ...
        <li>
            <a href="speakerinfo.html" class="nav-link-color-themeb nav-link-color" :class="{ active: isActive('speakerinfo') }" :aria-current="isActive('speakerinfo')">Speakers</a>
        </li>
        <li>
