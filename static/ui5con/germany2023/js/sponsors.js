  ...
  data() {
    return {
      ...
      sponsors: [
        ...
        {
          name: "CONET",
          logo:  `<svg class="ui5con-sponsor-logo" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="50 270 289.4 160">
                      <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="0" y1="839.06" x2=".707" y2="838.352">
                        <stop offset="0" stop-color="#1da238"/>
                        <stop offset=".983" stop-color="#24391d"/>
                      </linearGradient>
                    <path class="st0" fill="#fff" d="M105.2 359.4c-1.2-.7-2.8-1.4-4.6-2a29 29 0 0 0-5.9-.9c-5.3 0-9.6 1.8-12.8 5.2-3.3 3.4-5 8.2-5.1 14.2 0 6.2 1.9 11.1 5.4 14.5 3.5 3.5 7.7 5.3 12.8 5.3 4 0 7.4-.9 10.2-2.6l2.8 6.5c-1.6.9-3.6 1.8-6 2.5s-4.9 1.1-7.4 1.1c-8.9-.1-15.8-2.8-20.8-7.9-5.2-5.1-7.8-11.5-7.8-19.4 0-7.4 2.6-13.7 7.7-18.8 5.1-5.2 12.1-7.8 21-7.9 2.7 0 5.2.4 7.5 1.2 2.4.8 4.4 1.7 6.1 2.8l-3.1 6.2zm32.6 43.7c-7.8-.1-13.9-2.8-18.3-8.1-4.5-5.2-6.8-11.7-6.9-19.7 0-7.5 2.5-13.7 7.2-18.6 4.6-5 10.6-7.5 18-7.6 7.4.1 13.4 2.6 18.1 7.6 4.7 4.9 7 11.1 7.2 18.6 0 7.9-2.3 14.5-6.7 19.7-4.6 5.2-10.7 7.9-18.6 8.1zm0-7.5c5.3-.1 9-2.2 11.2-6.4 2.1-4 3.2-8.7 3.2-13.9 0-5-1.1-9.4-3.3-13.1-2.4-3.7-6-5.6-11-5.7-5 .1-8.6 2-10.9 5.7-2.4 3.7-3.5 8.1-3.5 13.1 0 5.2 1 9.9 3.2 13.9 2.2 4.2 5.9 6.3 11.1 6.4zM170 277.1V350h7.4c9.7 11.6 19.3 24 28.8 37.2h.1V350h8.1v52.2h-7.3c-9.7-11.7-19.3-24.2-28.9-37.4h-.1v37.4H170v18.9h144v-144H170zm88.7 125h-30.6V350h27.5v7h-17v14.4h16.6v7h-16.6v16.9h20.1v6.8zM305 357h-15.6v45.2h-10.5V357h-15.6v-7H305v7z"/>
                  </svg>`,
          ...
          website: "https://www.conet.de/DE/karriere/jobs/2021-113--SAP-Entwickler",
