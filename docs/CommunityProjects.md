...
[OpenUI5-FHIR](https://github.com/SAP/openui5-fhir) | [@openui5fhirbot](https://github.com/openui5fhirbot) | JS Library | OpenUI5-FHIR provides the `sap.fhir` UI5 library including the *FHIR Model* which simplifies the implementation of UI5 applications based on a FHIR® endpoint. | Apache 2.0
